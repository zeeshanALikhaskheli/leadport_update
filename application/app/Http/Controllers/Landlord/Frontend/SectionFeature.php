...
class SectionFeature extends Controller {
    ...
    public function edit($id) {
        ...
        return view('landlord/frontend/feature/page', compact('page', 'section'))->render();
    ...
    public function update(FileRepository $filerepo, $id) {
        ...
        $jsondata['redirect_url'] = url("app-admin/frontend/section/$id/feature");
    ...
    private function pageSettings($section = '', $data = []) {
        ...
        if($section == 'section-2'){
            ...
            $page['inner_menu_tab_section_2'] = 'active';
        }
        ...
        if($section == 'section-4'){
            ...
            $page['inner_menu_tab_section_4'] = 'active';
        }
