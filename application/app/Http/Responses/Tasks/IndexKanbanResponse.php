    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            if (request('action') == 'load') {
                ...
                $html = view($template, compact('page', 'boards', 'stats', 'tags', 'milestones', 'statuses', 'fields', 'priorities'))->render();
                $jsondata['dom_html'][] = array(
            ...
            if (auth()->user()->pref_hide_completed_tasks == 'yes') {
                $jsondata['dom_classes'][] = [
                    'selector' => '#pref_hide_completed_tasks',
                    'action' => 'add',
                    'value' => 'active',
                ];
            } else {
            ...
            //standard view
            return view('pages/tasks/wrapper', compact('page', 'boards', 'stats', 'tags', 'milestones', 'statuses', 'fields', 'priorities'))->render();
        }
    }
}
