<div class="card count" id="ai-email-parser-wrapper">
    <div class="card-body">
        ...
        <div class="parser-details">
            ...
            <form method="POST" action="<?php echo e(route('user.updateAppPassword')); ?>">
                <?php echo csrf_field(); ?>
                <div class="form-group" style="max-width: 400px;">
                    <label for="userEmail">User Email</label>
                    <input type="email" id="userEmail" class="form-control" value="<?php echo e(Auth::user()->email); ?>" disabled>
                </div>
...
<?php /**PATH C:\xampp\htdocs\leadport\application\resources\views/pages/emails/components/table/form.blade.php ENDPATH**/ ?>