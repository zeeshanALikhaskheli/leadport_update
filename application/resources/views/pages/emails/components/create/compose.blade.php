                    ...
                    <div class="row mt-3" >
                      ...
                      <div class="row mt-3" >
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control"value="{{$email->quantity}}" name="quantity" placeholder="Quantity" aria-label="quantity">
                        </div>
              ...
              <div class=" col-sm-12 col-lg-6 " >
                  ...
                  <div class="row mt-3" >
                    ...
                    <div class="col">
                      ...
                      <input type="date" class="form-control" id="shipper_date" name="shipping_date" placeholder="Date" aria-label="date" value="{{$email->shipping_date}}">
                  </div>
                  <div class="col">
                    <label for="id" class="form-label fw-bold">Time</label>
                    <input type="time" class="form-control" name="shipping_time" placeholder="Id" aria-label="time" value="{{$email->shipping_time}}">
                </div>
                    </div>
                    <div class="row mt-3" >
                      <div class="col-12">
                          <label for="shipper" class="form-label fw-bold">Shipper</label>
                          <input type="text" class="form-control" placeholder="Add Shipper" name="shipper_name" aria-label="shipper" value="{{$email->shipper_name}}">
                        </div>
                    </div>
                    <div class="row mt-3" >
                      <div class="col">
                    ...
                    <div class="col">
                      ...
                      <input type="text" class="form-control" placeholder="City" name="shipping_city" aria-label="City" onkeypress="initAutocomplete('pickup_city')" id="pickup_city" value="{{$email->shipper_city}}">
                  </div>
                      <div class="col-sm-12 col-lg-6">
                        <label for="country" class="form-label fw-bold">Index </label>
                        <input type="number" class="form-control" placeholder="Add index" name="shipping_index" aria-label="country" value="{{$email->shipper_index}}">
                        </div>

                          <div class="col-12 mt-3">
                            <label for="Address" class="form-label fw-bold">Address </label>
                            <input type="text" class="form-control" placeholder="Address" name="shipping_address" aria-label="Address" onkeypress="initAutocomplete('pickup_address')" id="pickup_address" value="{{$email->shipper_address}}">
                            ...
                            <div id="pickupRemarks">
                                ...
                                <div class="pickupRemarks">
                                    <input type="text" class="form-control pickup" name="pickupRemarks[0]" placeholder="pickupRemarks" aria-label="Pickup Remark" value="{{$email->pickup_remarks}}">
                ...
                <div class="col-sm-12 col-lg-6">
                  ...
                  <div class="row mt-3" >
                    <div class="col">
                      ...
                      <input type="date" class="form-control" id="consignee_date" name="delivery_date" placeholder="Date" aria-label="date" value="{{$email->consignee_date}}">
                  </div>
                  <div class="col">
                    <label for="id" class="form-label fw-bold">Time</label>
                    <input type="time" class="form-control" placeholder="Id" name="delivery_time" aria-label="time" value="{{$email->consignee_time}}">
                </div>
                </div>
                    ...
                    <div class="row mt-3" >
                      <div class="col">
                        ...
                        <input type="text" class="form-control" placeholder="Add Consignee" name="consignee_name" aria-label="consignee" value="{{$email->consignee_name}}" >
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col">
                          <label for="City" class="form-label fw-bold">City</label>
                        <input type="text" class="form-control" placeholder="City" name="delivery_city" aria-label="City" onkeypress="initAutocomplete('delivery')" id="delivery" value="{{$email->consignee_city}}">
                      </div>
                      
                        <div class="col-sm-12 col-lg-6">
                        <label for="country" class="form-label fw-bold">Index</label>
                        <input type="number" class="form-control" placeholder="Add index" name="delivery_index" aria-label="country" value="{{$email->consignee_index}}">
                        </div>
                        
                          <div class="col-12 mt-3">
                            <label for="Address" class="form-label fw-bold">Address</label>
                            <input type="text" class="form-control" placeholder="Address" name="delivery_address" aria-label="Address" onkeypress="initAutocomplete('delivery_address')" id="delivery_address" value="{{$email->consignee_address}}">
                          ...
                          <div id="delivery-container" class="col-12 mt-3 delivery">
                            ...
                            <div id="deliveryRemarks">
                                ...
                                <div class="deliveryRemarks">
                                    <input type="text" class="form-control delivery" name="deliveryRemarks[0]" placeholder="deliveryRemarks" aria-label="Delivery Remark" value="{{$email->delivery_remarks}}">
                                    <i class="sl-icon-trash custom" onclick="removeField(this)"></i>
                                </div>
                            </div>
                        </div>
      ...
      <!-- form row four -->
            <div class="row mt-3">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        ...
                        <input type="text" class="form-control" name="temp_range" placeholder="Type Range here" aria-label="range" value="{{$email->temperature_range}}">
                    </div>
                    <div class="col-sm-4 col-lg-2">
                ...
                <div class="col-sm-4 col-lg-2">
                    ...
                    <input type="text" class="form-control" name="un_code" placeholder="Type UN code here" aria-label="code" value="{{$email->un_code}}">
                </div>
                <div class="col-sm-4 col-lg-2">
            ...
            <input type="text" class="form-control" name="notes" placeholder="About Notes" aria-label="notes" value="{{$email->notes}}">
            </div>
          ...
          <div class="row mt-2"> <!-- Optional mt-2 for margin -->
              <input type="number" class="form-control" name="chargeable_weight_total" placeholder="Chargeable Weight Total" id="ChargeableWeightTotal" value="{{$email->chargeable_weight}}">
          </div>
