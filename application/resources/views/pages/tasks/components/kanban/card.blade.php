...
<div class="kanban-card kanban-board-element show-modal-button reset-card-modal-form js-ajax-ux-request"
    ...
    <div class="x-meta">
        ...
        <label class="label {{ runtimeTaskPriorityColors($task->task_priority, 'label') }} p-t-3 p-b-3 p-l-8 p-r-8 custum"
            data-toggle="tooltip"
            title="{{ cleanLang(__('lang.transport')) }}">{{ cleanLang(__('lang.transport')) }}</label>
        @endif
