<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum"
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger"
            ...
            data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}" id="checkbox-actions-delete-tickets">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-info"
            data-type="form" data-ajax-type="POST" data-form-id="tickets-list-table"
            data-url="{{ url('/tickets/archive?ref=list') }}"
            data-confirm-title="@lang('lang.archive_tickets')"
            data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}" id="checkbox-actions-delete-tickets">
            <i class="ti-archive"></i> @lang('lang.archive')
        </button>

        <!--restore-->
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-info"
            data-type="form" data-ajax-type="POST" data-form-id="tickets-list-table"
            data-url="{{ url('/tickets/restore?ref=list') }}"
            data-confirm-title="{{ cleanLang(__('lang.restore_tickets')) }}"
            data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}" id="checkbox-actions-delete-tickets">
            <i class="ti-folder"></i> @lang('lang.restore')
        </button>
        ...
        <button type="button"
            ...
            data-url="{{ urlResource('/tickets/change-status') }}"
            data-action-url="{{ urlResource('/tickets/change-status?type=bulk') }}" data-action-method="POST"
            ...
            <i class="ti-bookmark"></i> {{ cleanLang(__('lang.change_status')) }}
        </button>
