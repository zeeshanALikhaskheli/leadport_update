...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button type="button"
            ...
            data-url="{{ url('fooos/create?foooresource_id=' . request('foooresource_id') . '&foooresource_type=' . request('foooresource_type')) }}"
            data-loading-target="commonModalBody" 
            data-modal-title="@lang('lang.add_fooo')"
            data-action-url="{{ url('fooos?foooresource_id=' . request('foooresource_id') . '&foooresource_type=' . request('foooresource_type')) }}"
