        ...
        <nav class="sidebar-nav">
            <ul data-modular-id="main_menu_client" id="sidebarnav">
                ...
                <li data-modular-id="main_menu_client_home"
                    ...
                    <a class="waves-effect waves-dark" href="leadport/home" aria-expanded="false" target="_self">
                        <i class="ti-home"></i>
                ...
                <li data-modular-id="main_menu_client_proposals"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="leadport/proposals" aria-expanded="false"
                        target="_self">
                ...
                <li data-modular-id="main_menu_client_contracts"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="leadport/contracts" aria-expanded="false"
                        target="_self">
                        <i class="ti-write"></i>
                ...
                <li data-modular-id="main_menu_client_users"
                    ...
                    <a class="waves-effect waves-dark" href="leadport/users" aria-expanded="false" target="_self">
                ...
                <li data-modular-id="main_menu_client_tickets"
                    ...
                    <a class="waves-effect waves-dark" href="leadport/tickets" aria-expanded="false" target="_self">
                ...
                <li data-modular-id="main_menu_client_knowledgebase"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="leadport/knowledgebase" aria-expanded="false"
                        target="_self">
